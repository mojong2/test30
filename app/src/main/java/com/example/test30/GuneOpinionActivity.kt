...
import kotlinx.android.synthetic.main.gune_opinion_main.*
import kotlinx.android.synthetic.main.gune_opinion_main.listView
import kotlinx.android.synthetic.main.gune_opinion_main.back_button
import kotlinx.android.synthetic.main.gune_write_main.*
import kotlinx.android.synthetic.main.gune_write_main.view.*
import kotlinx.android.synthetic.main.gune_main.*
...
class GuneOpinionActivity : AppCompatActivity() {
    ...
    inner class ListViewAdapter2(private val items: MutableList<ListViewItem2>): BaseAdapter() {
        ...
        override fun getView(position: Int, view: View?, parent: ViewGroup?): View {
            ...
            if (convertView == null)
                convertView = LayoutInflater.from(parent?.context)
                    .inflate(R.layout.opinion_list_item, parent, false)
    ...
    companion object {
        lateinit var instance: GuneOpinionActivity
        fun GuneOpinionActivityContext(): Context {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.setOnItemClickListener { parent: AdapterView<*>, view: View, position: Int, id: Long->
            val item = parent.getItemAtPosition(position) as ListViewItem2
